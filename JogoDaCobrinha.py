...
class Comida:
    def __init__(self, tam_tela=(300,400)):
        ...
        self.posicao = [random.randrange(10,self.tam_tela[0], 10), random.randrange(10,self.tam_tela[1],10)]
        self.devorada = False
...
class Cobra:
    ...
    def move(self, posicao_comida):
        ...
        if self.direcao == "BAIXO":
         ...
         # adiciona pedaço do corpor da cobra na frente da cabeça
    ...
    def verifica_colisao(self):
        ...
        if self.posicao[0] > (self.tam_tela[1]-10) or self.posicao[1] < 0:
            return True
...
# iniciar fonte
pygame.font.init()
minha_fonte = pygame.font.SysFont('Arial', 30)
...
while True:
    ...
    tela.fill((7,0,35)) #RGB - Red - Blue - Purple - (255,255,255)
    ...
    if cobra.verifica_colisao():
        pontos = minha_fonte.render(f"Pontuacao: {pontuacao}", True, (255,255,255))
        tela.blit(pontos, (10, 10))

        voce_perdeu = minha_fonte.render("IIIIHHHH, PERDEU! KKKKK", True, (255,255,255))
